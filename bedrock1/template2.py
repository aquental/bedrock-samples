...
# TODO: Initialize global conversation history
...
def send_message(user_text):
    try:
        # TODO: Append user message to global conversation history
        conversation.append({
            "role": "user",
            "content": [{"text": user_text}]
        })

        # TODO: Prepare the API call parameters with global system prompt
        api_params = {
            "modelId": MODEL_ID,
        ...
        # TODO: Add the assistant's response to conversation history for chaining
